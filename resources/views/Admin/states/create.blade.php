...
View States
                    ...
                    <div class="card-body">
                      <div class="row g-xl-5 g-3">
                        <div class="col-sm-12">
                            <form id="advance-tab" action="{{route('states.store')}}" method="post" >
                              @csrf
                                ...
                                <div class="col-lg-12 col-sm-6">
                                    ...
                                    <input class="form-control      
                                     @error('state')
                                    is-invalid
                                    @enderror" id="exampleFormControlInputa" type="text" placeholder="Enter Your State Name" name="state" value="{{old('state')}}">
