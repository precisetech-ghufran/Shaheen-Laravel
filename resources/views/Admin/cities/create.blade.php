                  ...
                  <div class="card"> 
                    <div class="card-header d-block d-md-flex justify-content-between">
                      ...
                      <div class="d-flex flex-wrap gap-2 mt-3 mt-md-0">
                        ...
                        <a class="btn btn-success" href="{{route('cities.index')}}">
View City
                        </a>
                      </div>
                    </div>
                    <div class="card-body">
                      <div class="row g-xl-5 g-3">
                        <div class="col-sm-12">
                            <form id="advance-tab" action="{{route('cities.store')}}" method="post" >
                              @csrf
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    ...
                                    <input class="form-control      
                                     @error('city')
                                    is-invalid
                                    @enderror" id="exampleFormControlInputa" type="text" placeholder="Enter Your State Name" name="city" value="{{old('city')}}">
