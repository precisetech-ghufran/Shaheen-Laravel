                    ...
                    <div class="card"> 
                      <div class="card-body">
                        <div class="card-header d-flex justify-content-between align-items-center">
                          <h4>  <a class="btn btn-primary" href="{{route('cities.create')}}">
                            Add City
                        </a></h4>
        ...
        <thead>
            <tr>
                <th><span class="f-light f-w-600">S.NO</span></th>
                 <th><span class="f-light f-w-600">City Name</span></th>
 ...
 @if(isset($results) && $results->isNotEmpty())
   ...
   @foreach($results as  $index=> $city)
    ...
    <tr class="product-removes">
             ...
             <td> 
                                      <div class="product-names">
                                        <a class="f-light" href="{{route('cities.edit',$city->id)}}"> {{ $city->name }}qq</a>
                                      </div>
                                    </td>
                                         ...
                                         <td> 
                                      <div class="product-names">
                                        <p class="f-light" > {{ $city->state->name }}qq</p>
                                      </div>
                                    </td>
    ...
    @elseif(isset($cities) && $cities->count() > 0)
