                            ...
                            <div class="col-12"> 
                                <div class="card"> 
                                    <div class="card-header d-block d-md-flex justify-content-between">
                                        <h5>{{$store->store_business_name}}</h5>
                                        <div class="d-flex gap-2 mt-3 mt-md-0">
                                            <a class="btn btn-danger" href="{{route('stores.edit',$store->id)}}">
                                                Edit
                                            </a>
                                            <a class="btn btn-success" href="{{route('Store_staus_update.edit',$store->id)}}">
                                               Update Store Status
                                            </a>
                                        </div>
                                    </div> 
