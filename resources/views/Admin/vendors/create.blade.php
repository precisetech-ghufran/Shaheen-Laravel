        ...
        <div class="row">
            ...
            <div class="form-group col-lg-4 col-sm-12">
                ...
                <input 
                    ...
                    value="{{ old('customer_service_phone_no') }}">
