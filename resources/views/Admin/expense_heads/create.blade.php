...
<div class="page-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-sm-12 mb-3">
                ...
                <input type="text" name="expense_head"  class="form-control  @error('expense_head') is-invalid @enderror" placeholder="Enter Expense head" value="{{ old('expense_head') }}" >
                @error('expense_head')
