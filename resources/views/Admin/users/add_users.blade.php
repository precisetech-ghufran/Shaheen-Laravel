...
<div class="page-body">
    ...
    <div class="container-fluid">
            ...
            <div class="card-body">
              <div class="row g-xl-5 g-3"> 
                <div class="col-sm-12">
                    ...
                    <form id="advance-tab" action="" method="post" class="row g-3" enctype="multipart/form-data">
                        @csrf
      ...
      <div class="col-lg-6 col-sm-6">
                            ...
                            <input class="form-control" id="exampleFormControlInputa"  name="email" type="email" value="{{old('email')}}" placeholder="Enter Your User Email">
  ...
  @enderror
                         ...
                         <div class="col-lg-6 col-sm-6">
                            ...
                            <input class="form-control" id="exampleFormControlInputa" type="text"  name="name" value="{{old('name')}}"  placeholder="Enter Your User Full Name">
                            @error('name')
                            <span class="text-danger">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <!--    <div class="col-lg-6 col-sm-6">
                         ...
                         <div class="col-lg-6 col-sm-6">
                            ...
                            <input class="form-control" id="user_name" type="text"  name="user_name" value="{{old('user_name')}}" placeholder="Enter Your User UserName">
                            @error('user_name')
                            <span class="text-danger">{{ $message }}</span>
                          @enderror
                        </div>
                    ...
                    <div class="col-lg-6 col-sm-6"> 
                         ...
                         name="phone_number" value="{{old('phone_number')}}" placeholder="Enter Your User Phone Number">
                               @error('phone_number')
                            <span class="text-danger">{{ $message }}</span>
                          @enderror
                        </div>
