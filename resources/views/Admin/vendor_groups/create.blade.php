...
View Vendor Group
        ...
        <div class="form-group">
            <label for="vendor_group">Vendor Group<span class="text-danger">*</span></label>
            <input type="text" name="vendor_group" id="vendor_group" class="form-control @error('vendor_group') is-invalid @enderror" value="{{ old('vendor_group', $vendorGroup->vendor_group ?? '') }}" placeholder="Enter Your Vendor Group">
            @error('vendor_group')
